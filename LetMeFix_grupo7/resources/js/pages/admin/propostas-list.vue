<template>
<div>
    <center> <h3>Lista de Propostas</h3> </center>
    ...
    <table class="table">
        <tr>
            ...
            <th scope="col">Data fim de obra</th>
...
<script>
  export default {
    ...
    mounted() {
        axios.get("http://localhost:8000/api/admin/propostas").then((response) => {
