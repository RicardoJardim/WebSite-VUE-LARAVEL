...
<body>
    ...
    <div class="form-popup" v-bind:id="proposta.proposta.id">
      <form action="/#" class="form-container">
        ...
        <div> <a <router-link class="user" v-bind:to="{ path: `/me/propostas/${proposta.proposta.id}` }"> <button type="button" class="btn btn-success btn-block float-right" >Visitar</button> </router-link></a> </div>
      </form>
    </div>
    <hr>
</body>
...
export default {
    ...
    methods:{
        ...
        {
            axios.put(`http://localhost:8000/api/propostas/update/${this.proposta.id}`, {
